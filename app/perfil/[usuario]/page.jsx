    ...
    <main className="min-h-screen bg-yellow-50 flex flex-col">
      ...
      <div className="w-full px-6 lg:px-[115px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between lg:items-start">
          ...
          <div className="w-[230px] h-[230px] mx-auto lg:ml-[65px] bg-gray-200 rounded-full mt-[-150px] border-yellow-50 shrink-0"></div>

          <div className="mt-8 self-center lg:self-auto">
            <BotaoPerfil />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between lg:items-end mt-12">
          ...
          <div type="text" className="text-violet-600 text-lg w-full lg:w-auto h-[43px] font-thin text-left lg:text-right">ver mais</div>
        </div>
