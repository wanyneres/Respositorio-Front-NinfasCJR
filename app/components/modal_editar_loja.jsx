...
import { CATEGORIAS_LOJA } from "../../categorias_lojas";

export default function ModalEditarLojas({ Aberto, Fechado, Salvar, Deletar}) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 flex justify-center items-center p-4" onClick={Fechado}>
            ...
            <div className="bg-gray-200 rounded-xl shadow-lg p-6 flex flex-col items-center sm:max-h-screen max-h-[80vh] w-full max-w-md sm:max-w-3xl overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="rounded-full bg-white z-0 sm:max-w-xl w-full flex items-center px-7">
                ...
                <div className="relative mt-6 sm:max-w-xl w-full">
                ...
                <div className="mt-7 rounded-xl p-6 border-2 sm:max-w-xl relative flex flex-col items-center border-dashed border-violet-600 h-[145px] w-full cursor-pointer" onClick={() => inputFotoPerfilLojaRef.current.click()}>
                    <div className="mt-5">
                ...
                <div className="mt-3 rounded-xl p-6 border-2 sm:max-w-xl relative flex flex-col items-center border-dashed border-violet-600 h-[145px] w-full cursor-pointer" onClick={() => inputLogoRef.current.click()}>
                    <div className="mt-5">
                        <Image src="/images/file.svg" alt="X" width={35} height={35}/>
                    </div>
                ...
                <div className="mt-3 rounded-xl p-6 border-2 sm:max-w-xl relative flex flex-col items-center border-dashed border-violet-600 h-[145px] w-full cursor-pointer" onClick={() => inputBannerRef.current.click()}>
                    <div className="mt-5">
                ...
                <button type="button" className="bg-[#FF0000] sm:max-w-xl text-white flex justify-center items-center flex-none text-lg mt-7 w-full h-[50px] rounded-full font-light" onClick={handleDelete}>DELETAR</button>

                <button type="button" className="bg-violet-600 sm:max-w-xl text-yellow-50 mt-4 text-lg h-[50px] w-[200px] flex justify-center items-center flex-none sm:w-[300px] rounded-full font-light" onClick={handleSubmit}>SALVAR</button>
            </div>
        </div>
    );
}